 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceImplService", targetNamespace = "http://impl.service.crm.leo.com/", wsdlLocation = "http://10.33.8.112:8080/ssh_Crm/service/customer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.crm.leo.com/", "CustomerServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.33.8.112:8080/ssh_Crm/service/customer?wsdl");
    ...
    public CustomerService getCustomerServiceImplPort() {
        return super.getPort(new QName("http://impl.service.crm.leo.com/", "CustomerServiceImplPort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.crm.leo.com/", "CustomerServiceImplPort"), CustomerService.class, features);
    }
