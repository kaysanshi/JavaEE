 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://service.leo.com/", wsdlLocation = "http://10.33.8.112:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://service.leo.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.33.8.112:8080/hello?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://service.leo.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.leo.com/", "HelloServicePort"), HelloService.class, features);
    }
