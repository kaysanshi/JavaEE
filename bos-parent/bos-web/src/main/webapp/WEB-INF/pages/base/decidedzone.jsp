...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div style="height:31px;overflow:hidden;" split="false" border="false" >
			<div class="datagrid-toolbar">
				...
				<script type="text/javascript">
					$(function(){
						$("#save").click(function(){
							var v=$("#addDecidedzonForm").form(validate);
							if(v==true){
								$("#addDecidedzonForm").submit();
							}
						});
					});
				</script>
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addDecidedzonForm" method="post" action="decideZoneAction_add.action">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="bcStaff.id"  
    							data-options="valueField:'id',textField:'name',url:'staffAction_list.action'" />  
						</td>
					</tr>
					<tr height="300">
						<td valign="top">关联分区</td>
						<td>
							<table id="subareaGrid"  class="easyui-datagrid" border="false" style="width:300px;height:300px" data-options="url:'subareaAction_list.Action',fitColumns:true,singleSelect:false">
								<thead>  
							        <tr>  
							        <!-- 这里的id 会与冲突然后修改 id的名称，然后生成get方法返回id -->
