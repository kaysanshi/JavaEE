...
<script type="text/javascript">
	...
	function showHightCharts(){
		alert("分区分布图");
		$("#showSubareaWindow").window("open");
		$.post('subareaAction_findSubarea.action',function(data){
			$('#test').hightcharts({
				chart: {
	...
	$(function(){
		...
		$.fn.serializeJson=function(){  
            var serializeObj={};  
            var array=this.serializeArray();//创建一个对象成javaScript的数组
            $(array).each(function(){  
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addSubareaForm" action="subareaAction_add.action">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="bcRegion.id"  
    							...
    							data-options="valueField:'id',textField:'name', model:'remote', url:'regionAction_list.action'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
	...
	<div class="easyui-window" title="区域分区分布图" id="showSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div id ="test" style="height:31px;overflow:hidden;" split="false" border="false" >
