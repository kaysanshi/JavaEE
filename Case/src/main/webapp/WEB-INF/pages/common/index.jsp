...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			...
			if(v==true){
				...
				if(pass1==pass2){
					$.post("userAction_editPassword.action",{"password" : pass1},function(data){
						if(data=='1'){
							//修改成功
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("this is by leo product");
	}
</script>
</head>
				...
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							 | Powered by <a href="http://www.kay555.cn/">leo555kay</a>
						</div>
					</td>
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                ...
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input id="txtNewPass" data-options="valideType:'length[4,6]'" type="Password" class="txt01 easyui-validatebox" required="required" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input id="txtRePass" type="Password" class="txt01 easyui-validatebox" required="required" data-options="valideType:'length[4,6]'"/></td>
                    </tr>
                </table>
                </form>
            </div>
