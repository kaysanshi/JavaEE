...
<body>
	<div
		...
		<span style="float: right; margin-top: 35px; color: #488ED5;">深圳百科科技</span>
	</div>
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
				<form id="loginform" name="loginform" method="post" class="niceform"
					...
					<div style="margin-top:10px;align:center"><font color="red"><s:actionerror/></font></div>
				</form>
			</div>
		</div>
	</div>
	<div
		...
		<span style="color: #488ED5;">Powered By www.leoi555.cn</span><span
